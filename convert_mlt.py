...
SRC_DATASET_DIR = '/opt/ml/ICDAR19'  # FIXME
DST_DATASET_DIR = '/opt/ml/ICDAR19/icdar17'  # FIXME
...
def main():
    ...
    mlt_train = MLT17Dataset(osp.join(SRC_DATASET_DIR, 'raw/images'), ###
                             osp.join(SRC_DATASET_DIR, 'raw/gt'), ###
